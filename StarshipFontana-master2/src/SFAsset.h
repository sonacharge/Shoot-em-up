 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_WALL, SFASSET_BACKGROUND};
...
public:
  ...
  virtual void      GoEastPlayer();
  virtual void      GoWestPlayer();
  virtual void      GoNorth();
  virtual void		GoNorthPlayer();
  virtual void		GoSouthPlayer();
  virtual void      SetNotAlive();
  virtual bool      IsAlive();
  virtual void      HandleCollision();
  virtual void		AlienMovementRight();
  virtual void		AlienMovementLeft();
